...
var json = function json() {
    ...
    var argv = (0, _yargs2.default)(args).usage('Usage: $0 json  <command> <file> <name> <value> [options]').command('get', 'get a json value by name').command('set', 'set a json value by name');
